...
object ScalaFormatData {
  ...
  def main(args: Array[String]) {
    ...
    val formated_data = splited_file.map(x => MyFucntions.mixDataInCorrectOrder(x(0), idxOfPersonId, MyFucntions.unpackData(1, x.slice(1, x.length))))
